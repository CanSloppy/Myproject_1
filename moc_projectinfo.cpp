/****************************************************************************
** Meta object code from reading C++ file 'projectinfo.h'
**
...
#error "The header file 'projectinfo.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ProjectInfo_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ProjectInfo_t qt_meta_stringdata_ProjectInfo = {
    {
QT_MOC_LITERAL(0, 0, 11) // "ProjectInfo"
...
QT_INIT_METAOBJECT const QMetaObject ProjectInfo::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ProjectInfo.data,
    qt_meta_data_ProjectInfo,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ProjectInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProjectInfo.stringdata0))
